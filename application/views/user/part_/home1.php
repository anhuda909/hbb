      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="100">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-1.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="200">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-2.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="300">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-3.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="400">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-4.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="500">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-5.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="600">
            <img src="<?php echo base_url() ?>user/assets/img/clients/client-6.png" class="img-fluid" alt="">
          </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    <img src="<?php echo base_url() ?>user/assets/img/poster.jpg" class="testimonial-img" alt="">
                    <p>
                    <div class="btn btn-secondary">jumlah kursi : 50</div>
                    <div class="btn btn-secondary">jumlah tersedia : 25</div><br>
                    <a href="<?= base_url('C_login') ?>" class="btn btn-l">More <i class="bx bx-chevron-right"></i></a>
                    </p>
                  </div>
                </div><!-- End event item -->
                <div class="swiper-slide">
