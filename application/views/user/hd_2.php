                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li class="dropdown"><a class="getstarted scrollto" href="#"><span>user</span></a>
                            <ul>
                                <li><a href="<?= base_url('C_user/profil') ?>">profil</a></li>
                                <li><a href="<?= base_url('C_user/order') ?>">orders</a></li>
                                <li><a href="<?= base_url('C_user/payment') ?>">payment confirmation</a></li>
                                <li><a class="getstarted scrollto" href="<?= base_url('C_login') ?>">log out</a></li>
                            </ul>
                        </li>
                    </ul>
