                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        <a class="btn btn-sm btn-light text-primary" href="<?= base_url('C_admin/add_event') ?>">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="<?= base_url('C_admin/e_event') ?>"><i data-feather="edit"></i></a>
