                                        ...
                                        <form>
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter Id tiket" value="08886756" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputLastName">Event</label>
                                                    <input class="form-control" id="inputLastName" type="text" placeholder="Enter event" value="Tiger team vs Lion team" />
                                                </div>
                                            </div>
                                            <!-- Form Group (email address)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputEmailAddress">Location</label>
                                                <input class="form-control" id="inputEmailAddress" type="text" placeholder="Enter your email address" value="GBK" />
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="price" type="number" placeholder="Enter price" value="50.000" />
                                            </div>
                                            <!-- Form Group (Roles)-->
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example">
                                                    ...
                                                    <option value="administrator" selected>Weekdays</option>
                                                    <option value="registered">Weekend</option>
                                                </select>
                                            </div>
                                            <!-- Submit button-->
                                            <button class="btn btn-primary" type="button">Edit Tiket</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
